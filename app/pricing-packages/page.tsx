  ...
  return (
    <div className="w-full min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      {/* =========================================================
          ...
          ========================================================= */}
      <section className="w-full bg-gradient-to-br from-zinc-500 to-cyan-900 dark:from-gray-950 dark:to-zinc-900 text-white py-16 px-6 sm:px-12 lg:px-[108px] transition-all">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#packages" className="inline-flex items-center justify-center h-12 px-6 bg-fuchsia-700 hover:bg-fuchsia-800 text-white font-semibold text-base rounded-lg shadow-sm transition-colors duration-200">
                See Packages
              </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-slate-50 dark:bg-gray-800 rounded-xl p-8 border border-slate-200 dark:border-gray-700 flex flex-col justify-between items-center text-center shadow-sm min-h-[240px]">
                ...
                <button className="h-11 px-6 bg-fuchsia-700 hover:bg-fuchsia-800 text-white text-sm font-semibold rounded-lg w-full transition-colors duration-200">
                  {box.btn}
                </button>
              </div>
            ))}
