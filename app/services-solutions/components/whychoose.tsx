...
export default function WhyChooseUs() {
  return (
    <section className="w-full bg-sky-900 text-white py-16 md:py-12 px-7 overflow-hidden">
      <div className="max-w-[1440px] mx-auto md:px-12 lg:px-[90px]">
        
        {/* ================= SECTION TITLE ================= */}
        <h2 className="text-center text-2xl md:text-3xl font-semibold tracking-tight leading-tight md:leading-[64px] mb-12 md:mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8 lg:gap-19 items-start text-center">
          {features.map((feature, idx) => (
            ...
            >
              <div className="w-10 h-10 flex items-center justify-center overflow-hidden mb-5 opacity-90 group-hover:scale-105 transition-transform duration-200">
                {feature.iconSlot}
              </div>

              {/* Title Frame */}
              <h3 className="text-lg md:text-xl font-semibold leading-7 md:leading-8 mb-2">
                {feature.title}
              </h3>

              {/* Description Frame */}
              <p className="text-sm md:text-base font-normal leading-6 text-white/80 max-w-[220px]">
                {feature.description}
              </p>
            </div>
          ))}
