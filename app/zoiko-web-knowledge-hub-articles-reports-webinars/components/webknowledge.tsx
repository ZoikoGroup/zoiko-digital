...
export default function KnowledgeHub() {
  return (
    <>
        ...
        <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <a 
                href="#" 
                className="inline-flex items-center justify-center px-6 h-12 bg-fuchsia-700 hover:bg-fuchsia-800 text-white font-semibold text-base rounded-lg shadow-md transition-colors duration-200"
              >
                Explore Resources
              </a>
              <a 
                href="#" 
                className="inline-flex items-center justify-center px-6 h-12 bg-white hover:bg-gray-100 text-fuchsia-700 dark:bg-transparent dark:text-white dark:border dark:border-white dark:hover:bg-white/10 font-semibold text-base rounded-lg shadow-sm transition-colors duration-200"
              >
      ...
      <section className="w-full bg-fuchsia-50 dark:bg-gray-900 border-b border-slate-200 dark:border-gray-800 py-12 px-4 sm:px-8 lg:px-24 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-4 pb-8 border-b border-slate-200 dark:border-gray-800 mb-10">
            <div className="relative w-full max-w-xl mx-auto">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 h-12 bg-slate-50 dark:bg-gray-800 dark:text-white rounded-xl border border-slate-200 dark:border-gray-700 text-base placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-fuchsia-600"
              />
            </div>

            <div className="flex flex-wrap items-center justify-center gap-3 w-full mt-2">
              <div className="relative w-full sm:w-48">
                <select className="w-full h-9 px-4 bg-white dark:bg-gray-800 dark:text-white rounded-lg border border-slate-200 dark:border-gray-700 text-sm text-zinc-500 dark:text-zinc-300 focus:outline-none appearance-none cursor-pointer">
              ...
              <button className="w-full sm:w-auto h-8 px-4 bg-white/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800 text-slate-500 dark:text-zinc-300 text-sm font-normal rounded-lg border border-slate-200 dark:border-gray-700 transition-colors">
                Clear All
              </button>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-2 sm:px-10">
              {/* Card 1 */}
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 dark:border-gray-700 overflow-hidden flex flex-col group hover:shadow-md transition-shadow">
                <div className="relative w-full h-48 bg-neutral-400">
                  <Image 
                    ...
                    height={379}
                  />
                  <span className="absolute top-4 left-4 bg-fuchsia-700 text-white text-xs font-semibold px-3 py-1 rounded-full shadow-sm">
                    Case Study
                  </span>
                </div>
                <div className="p-5 flex flex-col flex-grow justify-between min-h-[160px]">
                  <div>
                    <h3 className="text-slate-800 dark:text-white text-lg font-semibold leading-snug mb-2 group-hover:text-fuchsia-700 dark:group-hover:text-fuchsia-400 transition-colors">
                  ...
                  <div className="flex items-center gap-4 mt-4 pt-3 border-t border-slate-100 dark:border-gray-700">
                    <span className="bg-slate-50 dark:bg-gray-700 px-3 py-1 text-slate-500 dark:text-zinc-300 text-xs font-medium rounded-full">
                      Telecommunications
                    </span>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 dark:border-gray-700 overflow-hidden flex flex-col group hover:shadow-md transition-shadow">
                <div className="relative w-full h-48 bg-neutral-400">
                  <Image 
                    className="w-full h-full object-cover" 
                    src="/images/Knowledgehub/safety-gear.png" 
            ...
            {/* Carousel Controls */}
            <button className="hidden sm:flex absolute left-0 top-1/2 -translate-y-1/2 items-center justify-center w-10 h-10 bg-fuchsia-700 text-white rounded-full border border-slate-200 dark:border-gray-700 shadow-md transform -translate-x-2 md:-translate-x-5 hover:bg-fuchsia-800 active:scale-95 transition-all">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <button className="hidden sm:flex absolute right-0 top-1/2 -translate-y-1/2 items-center justify-center w-10 h-10 bg-fuchsia-700 text-white rounded-full border border-slate-200 dark:border-gray-700 shadow-md transform translate-x-2 md:translate-x-5 hover:bg-fuchsia-800 active:scale-95 transition-all">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((category, index) => (
              <div 
                key={index}
                className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-slate-200 dark:border-gray-700 flex flex-col items-center text-center justify-between min-h-[320px] hover:shadow-md transition-shadow duration-200"
              >
                {/* Top Content Area */}
                <div className="w-full flex flex-col items-center">
                  
                  {/* Matches your exact requested reference code structure */}
                  <div className="w-14 h-14 bg-fuchsia-100 dark:bg-fuchsia-950/40 rounded-xl flex items-center justify-center mb-5 overflow-hidden p-3.5">
                    <img 
                      className="relative w-full h-full object-contain flex items-center justify-center dark:brightness-0 dark:invert"
                      src={category.icon} 
                      alt="icon"
                    />
                  </div>
                ...
                <div className="w-full flex items-center justify-center gap-3 mt-6 pt-4 border-t border-slate-50 dark:border-gray-700/50">
                  <div className="px-4 py-1.5 bg-slate-50 dark:bg-gray-700 rounded-full">
                  ...
                  <a 
                    href="#" 
                    className="px-4 py-2 rounded-lg border border-fuchsia-700 dark:border-fuchsia-500 text-fuchsia-700 dark:text-fuchsia-400 text-sm font-medium hover:bg-fuchsia-50 dark:hover:bg-fuchsia-950/20 whitespace-nowrap transition-colors duration-200"
                  >
                    {category.actionText}
                  </a>
                </div>
